...
#define PWM_TIMER_PERIOD		0xFFFFFFFF
...
//		printf("timer->tim: 0x%x, %s, %d\r\n", (uint32_t)timer->tim, __FUNCTION__, __LINE__);					// 0x40000c00: TIM5 address
//		printf("timer->channel: 0x%x, %s, %d\r\n", timer->channel, __FUNCTION__, __LINE__);						// 0x0: TIM_Channel_1
//		printf("timer->tag: 0x%x, %s, %d\r\n", timer->tag, __FUNCTION__, __LINE__);								// 0x10: PA0
//		printf("timer->usageFlags: 0x%x, %s, %d\r\n", timer->usageFlags, __FUNCTION__, __LINE__);				// 0x2: TIM_USE_PWM
//		printf("timer->output: 0x%x, %s, %d\r\n", timer->output, __FUNCTION__, __LINE__);						// 0x1
//		printf("timer->alternateFunction: 0x%x, %s, %d\r\n", timer->alternateFunction, __FUNCTION__, __LINE__);	// 0x2: GPIO_AF_TIM5
