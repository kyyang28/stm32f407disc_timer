...
//	printf("spi->dev: 0x%x\r\n", (uint32_t)spi->dev);		// spi-dev = 0x40003800
//	printf("spi->nss: %u\r\n", spi->nss);					// spi->nss = 84
//	printf("spi->sck: %u\r\n", spi->sck);					// spi->sck = 45
//	printf("spi->miso: %u\r\n", spi->miso);					// spi->miso = 46
//	printf("spi->mosi: %u\r\n", spi->mosi);					// spi->mosi = 47
//	printf("RCC_APB1 << 5: 0x%x\r\n", (uint32_t)(2 << 5));
...
//	printf("ioRecSpiSck->gpio: 0x%x\r\n", (uint32_t)ioRecSpiSck->gpio);	// gpio = 0x40020400 (GPIOB)
//	printf("ioRecSpiSck->pin: %u\r\n", ioRecSpiSck->pin);				// pin = 8192 = 0x2000 (1 << 13)

//	ioRec_t *ioRecSpiMiso = IO_Rec(IOGetByTag(spi->miso));
//	printf("ioRecSpiMiso->gpio: 0x%x\r\n", (uint32_t)ioRecSpiMiso->gpio);	// gpio = 0x40020400 (GPIOB)
//	printf("ioRecSpiMiso->pin: %u\r\n", ioRecSpiMiso->pin);					// pin = 16384 = 0x4000 (1 << 14)

//	ioRec_t *ioRecSpiMosi = IO_Rec(IOGetByTag(spi->mosi));
//	printf("ioRecSpiMosi->gpio: 0x%x\r\n", (uint32_t)ioRecSpiMosi->gpio);	// gpio = 0x40020400 (GPIOB)
//	printf("ioRecSpiMosi->pin: %u\r\n", ioRecSpiMosi->pin);					// pin = 32768 = 0x8000 (1 << 15)
